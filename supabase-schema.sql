...
-- ── Enumerations ─────────────────────────────────────────────
create type user_role as enum ('intern', 'staff', 'registrar', 'management', 'researcher', 'admin');
...
create policy "Managers update locations"
  on locations for update to authenticated using (my_role() in ('management','admin'));
...
create policy "Users edit own; management edit any"
  on occurrences for update to authenticated
  using (created_by = auth.uid() or my_role() in ('management','admin'));
...
create policy "Managers delete media"
  on media for delete to authenticated using (my_role() in ('management','admin'));
...
create policy "Managers delete from media bucket"
  ...
  using (bucket_id = 'media' and my_role() in ('management','admin'));
